...
public class MSJEIRecipeType {
    ...
    public static final MekanismJEIRecipeType<MetalElectrolysisRecipe> METAL_ELECTROLYSIS = new MekanismJEIRecipeType<>(MSBlocks.METAL_ELECTROLYSIS_CHAMBER, MetalElectrolysisRecipe.class);
