...
public class AdsorptionRecipeCategory extends BaseRecipeCategory<AdsorptionRecipe> {
    private final GuiGauge<?> inputGauge;
    private final GuiGauge<?> outputGauge;
    private final GuiSlot inputSlot;

    public AdsorptionRecipeCategory(IGuiHelper helper, MekanismJEIRecipeType<AdsorptionRecipe> recipeType) {
