...
// All the same with Isotopic Centrifuge! :)
public class GuiPressurizedPolymerizerChamber extends GuiConfigurableTile<TileEntityPressurizedPolymerizingChamber, MekanismTileContainer<TileEntityPressurizedPolymerizingChamber>> {

    public GuiPressurizedPolymerizerChamber(MekanismTileContainer<TileEntityPressurizedPolymerizingChamber> container, Inventory inv, Component title) {
