...
public class MSContainerTypes {
    ...
    public static final ContainerTypeRegistryObject<MekanismTileContainer<TileEntityExtractingPlantCasing>> EXTRACTING_PLANT = CONTAINER_TYPES.custom("extracting_plant", TileEntityExtractingPlantCasing.class).offset(0, 12).build();
    public static final ContainerTypeRegistryObject<MekanismTileContainer<TileEntityAntiExtractingPlantCasing>> ANTI_EXTRACTING_PLANT = CONTAINER_TYPES.custom("anti_extracting_plant", TileEntityAntiExtractingPlantCasing.class).offset(0, 12).build();
