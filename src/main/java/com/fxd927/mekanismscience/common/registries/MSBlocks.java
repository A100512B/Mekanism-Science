...
public class MSBlocks {
    ...
    public static final BlockRegistryObject<BlockTileModel<TileEntityMetalElectrolysisChamber, BlockTypeTile<TileEntityMetalElectrolysisChamber>>, ItemBlockMachine> METAL_ELECTROLYSIS_CHAMBER = BLOCKS.register("metal_electrolysis_chamber", () -> new BlockTileModel<>(MSBlockTypes.METAL_ELECTROLYSIS_CHAMBER, properties -> properties.mapColor(BlockResourceInfo.STEEL.getMapColor())), ItemBlockMachine::new);
