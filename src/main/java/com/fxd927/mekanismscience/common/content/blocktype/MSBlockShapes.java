...
public final class MSBlockShapes {
    ...
    static {
        VoxelShapeUtils.setShape(VoxelShapeUtils.combine(
                ...
                box(-11, 4, 31, -3, 12, 32),
                box(-10, 5, 30, -5, 11, 31),
                box(10.749, 13.999, -6.001, 22.751, 22.001, -3.999),
                box(-1.251, 13.999, -6.001, 10.751, 22.001, -3.999),
                box(-13.251, 13.999, -6.001, -1.249, 22.001, -3.999),
                box(-2, 12, -12, 12, 13, -6),
                box(9, 7, -3, 13, 11, 2),
                box(-4, 7, -3, 0, 11, 2),
                box(4, 12, -4, 6, 17, -3),
                box(-9, 17, -4, 19, 19, -3),
                box(11.5, 14.75, -6, 22, 21.25, -6),
                box(-0.5, 14.75, -6, 10, 21.25, -6),
                box(-12.5, 14.75, -6, -2, 21.25, -6),
