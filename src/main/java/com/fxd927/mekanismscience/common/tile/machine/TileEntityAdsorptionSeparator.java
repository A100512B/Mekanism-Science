...
import com.fxd927.mekanismscience.common.recipe.lookup.ItemFluidRecipeLookupHandler;
...
public class TileEntityAdsorptionSeparator extends TileEntityProgressMachine<AdsorptionRecipe>
        implements ItemFluidRecipeLookupHandler<AdsorptionRecipe> {
    ...
    protected IInventorySlotHolder getInitialInventory(IContentsListener listener, IContentsListener recipeCacheListener) {
        ...
        builder.addSlot(inputSlot = InputInventorySlot.at(item -> containsRecipeAB(item, inputTank.getFluid()), this::containsRecipeA, recipeCacheListener, 80, 22))
    ...
    @Override
    @NotNull
    public IMekanismRecipeTypeProvider<AdsorptionRecipe, ItemFluid<AdsorptionRecipe>> getRecipeType() {
