...
public class SidedEnergyContainerHolder extends BasicHolder<IEnergyContainer> implements IEnergyContainerHolder {
    ...
    protected SidedEnergyContainerHolder(Supplier<Direction> facingSupplier, @Nullable Predicate<RelativeSide> insertPredicate, @Nullable Predicate<RelativeSide> extractPredicate) {
