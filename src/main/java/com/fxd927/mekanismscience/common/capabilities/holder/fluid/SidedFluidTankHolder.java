...
public class SidedFluidTankHolder extends BasicHolder<IExtendedFluidTank> implements IFluidTankHolder {
    ...
    protected SidedFluidTankHolder(Supplier<Direction> facingSupplier, @Nullable Predicate<RelativeSide> insertPredicate, @Nullable Predicate<RelativeSide> extractPredicate) {
