...
public class IrradiatingRecipeSerializer<RECIPE extends IrradiatingRecipe> implements RecipeSerializer<RECIPE> {

    private final IFactory<RECIPE> factory;

    public IrradiatingRecipeSerializer(IFactory<RECIPE> factory) {
    ...
    @FunctionalInterface
    public interface IFactory<RECIPE extends IrradiatingRecipe> {
