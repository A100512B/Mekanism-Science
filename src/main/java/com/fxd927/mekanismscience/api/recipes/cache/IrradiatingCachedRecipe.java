...
public class IrradiatingCachedRecipe extends CachedRecipe<IrradiatingRecipe> {
     ...
     */
    public IrradiatingCachedRecipe(IrradiatingRecipe recipe, BooleanSupplier recheckAllErrors, IInputHandler<@NotNull ItemStack> itemInputHandler,
